...
_SUPPORTED_REPORT_SCHEMAS: dict[str, frozenset[str]] = {
    ...
    "coherent-qsvt-execution": frozenset({"1.0"}),
...
_REQUIRED_REPORT_SCHEMA_FIELDS: dict[str, frozenset[str]] = {
    ...
    "coherent-qsvt-execution": frozenset(
        {
            "schema_name",
            "schema_version",
            "mode",
    ...
    "coherent-qsvt-execution": frozenset(
        {
            ...
            "maximum_probability_standard_error",
            "mode",
            "postselected_logical_output",
            "probabilities",
            "probability_normalization_error",
            "resource_summary",
            "schema_name",
            "schema_version",
            "selection_state_amplitudes",
            "selection_success_probability",
            "selection_success_standard_error",
            "selection_wires",
            "shots",
            "statevector_normalization_error",
            "succeeded",
