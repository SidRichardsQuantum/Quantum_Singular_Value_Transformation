...
See [Physics workflows](physics.md) for the detailed physics API
map.
...
- [Theory](theory.md): conceptual background
- [API reference](api_reference.md): public API details
- [Polynomial design](design.md): design helper reference
- [Polynomial templates](templates.md): reusable template families
- [Notebooks](notebooks.md): tutorial and real-example notebooks
- [Results](results.md): reproducible report and plot conventions
