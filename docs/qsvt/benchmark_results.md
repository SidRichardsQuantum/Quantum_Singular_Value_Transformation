...
This generated page displays embedded plots and text outputs from the repository's benchmark notebooks.
...
Source: [`notebooks/benchmarks/07_phase_synthesis_stress_matrix.ipynb`](../../notebooks/benchmarks/07_phase_synthesis_stress_matrix.ipynb)

```{image} ../../results/plots/benchmarks/07_phase_synthesis_stress_matrix-plot-01.png
:alt: Phase-Synthesis Stress Matrix plot 1
:width: 760px
```
